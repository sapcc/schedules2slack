...
build-all: build/schedule2slack

build/schedule2slack: FORCE
	go build $(GO_BUILDFLAGS) -ldflags '-s -w $(GO_LDFLAGS)' -o build/schedule2slack ./cmd
...
install: FORCE build/schedule2slack
	install -d -m 0755 "$(DESTDIR)$(PREFIX)/bin"
	install -m 0755 build/schedule2slack "$(DESTDIR)$(PREFIX)/bin/schedule2slack"
...
help: FORCE
	...
	@printf "  \e[36mbuild/schedule2slack\e[0m   Build schedule2slack.\n"
